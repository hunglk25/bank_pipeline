...
class DataUploader:
    ...
    def upload_all_data(self, conn, data):
        configs = {
            'customers': {
                'columns': ['NationalID', 'Name', 'Address', 'Contact', 'Username', 'PasswordHash'],
                'sql': """INSERT INTO Customer (NationalID, Name, Address, Contact, Username, PasswordHash)
                         VALUES (%s, %s, %s, %s, %s, %s) ON CONFLICT (Username) DO NOTHING"""
            },
            'devices': {
                'columns': ['CustomerID', 'DeviceType', 'DeviceInfo', 'IsVerified', 'LastUsed'],
                'sql': """INSERT INTO Device (CustomerID, DeviceType, DeviceInfo, IsVerified, LastUsed)
                         VALUES (%s, %s, %s, %s, %s)"""
            },
            'accounts': {
                'columns': ['CustomerID', 'AccountType', 'Balance', 'Currency', 'Status'],
                'sql': """INSERT INTO Account (CustomerID, AccountType, Balance, Currency, Status)
                         VALUES (%s, %s, %s, %s, %s)"""
            },
            'transactions': {
                'columns': ['FromAccountID', 'ToAccountID', 'TxnType', 'Amount', 'Timestamp', 'RiskFlag'],
                'sql': """INSERT INTO Transaction (FromAccountID, ToAccountID, TxnType, Amount, Timestamp, RiskFlag)
                         VALUES (%s, %s, %s, %s, %s, %s)"""
            },
            'auth_logs': {
                'columns': ['CustomerID', 'DeviceID', 'AuthMethod', 'AuthStatus', 'Timestamp'],
                'sql': """INSERT INTO AuthenticationLog (CustomerID, DeviceID, AuthMethod, AuthStatus, Timestamp)
                         VALUES (%s, %s, %s, %s, %s)"""
            }
        }
